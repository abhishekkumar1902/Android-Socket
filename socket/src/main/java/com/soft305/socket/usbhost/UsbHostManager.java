...
public class UsbHostManager {
        ...
        if (mUsbManager.hasPermission(usbDevice)) {
            ...
            synchronized (mUsbHostReceiver) {
                ...
                if (usbHostSocket == null) {
                    usbHostSocket = new UsbHostEmptySocket(this, usbDevice);
     ...
     * */
    private void createUsbHostSocket(UsbDevice usbDevice) {
        mCurSocket = new UsbHostSocket(this, usbDevice);
